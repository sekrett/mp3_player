...
This adds <i>player.swf</i> and <i>audio-player.js</i> to \_public/_>. You may use \+--skip-swfobject+ to add
\_audio-player-noswfobject.js_, if your layout already has included _swfobject_ like this:
